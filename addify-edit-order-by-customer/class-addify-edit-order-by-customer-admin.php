...
class Addify_Edit_Order_By_Customer_Admin {
	...
	public function edit_order_status_setting_field_callback() {
		...
		$statuses    = wc_get_order_statuses();
			...
			unset($statuses['wc-cancelled'], $statuses['wc-refunded'], $statuses['wc-failed'], $statuses['wc-checkout-draft'], $statuses['wc-completed']);
		?>
			...
			<?php
			foreach ($statuses as $valr_status  => $name_status ) :
				?>
	...
	public function shipping_method_order_status_setting_field_callback() {
		...
		<?php
		foreach ($statuses as $value_status  => $shipping_status ) :
