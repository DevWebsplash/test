...
<table class="addf_disc_rpc_table">
	<tr>
		...
		<td>
			...
			<br>
			<p class="description"><?php echo esc_html__( 'Choose product selection method for cart rule', 'woo-af-drpc' ); ?></p>
		</td>
	</tr>
	<tr class="addf_drpc_hidden_fields addf_disc_rpc_product_selection_op addf_disc_rpc_product_selection_op_specific">
		...
		<td>
			...
			<br>
			<p class="description"><?php echo esc_html__( 'Choose specific products for cart rule', 'woo-af-drpc' ); ?></p>
		</td>
	</tr>
	<tr class="addf_drpc_hidden_fields addf_disc_rpc_product_selection_op addf_disc_rpc_product_selection_op_specific">
		<td>
		...
		<select id="addf_disc_rpc_categories" name="addf_disc_rpc_categories[]" multiple="multiple" style="width:60%">
			...
			<br>
			<p class="description"><?php echo esc_html__( 'Choose categories for cart rule', 'woo-af-drpc' ); ?></p>
		</td>
	</tr>
</table>
