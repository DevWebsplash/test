	...
	<table class="addf_disc_rpc_table">
		...
		<tr>
			...
			<td>
				...
				<br>
				<p class="description"><?php echo esc_html__( 'Select priority for this rule ', 'woo-af-drpc' ); ?></p>	
			</td>
		</tr>
		<!-- Days -->
		<tr >
			...
			<td>
				...
				<br>
				<p class="description"><?php echo esc_html__( 'Select days setting for this rule ', 'woo-af-drpc' ); ?></p>	
				...
				<br>
				<p class="description addf_disc_rpc_days_radio addf_disc_rpc_days_radio_specific addf_drpc_hidden_fields"><?php echo esc_html__( 'Select specific days for rule. ', 'woo-af-drpc' ); ?></p>	
			</td>
		</tr>
		<!-- Date -->
		<!-- Start Date -->
